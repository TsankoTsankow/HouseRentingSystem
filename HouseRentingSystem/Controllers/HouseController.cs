...
namespace HouseRentingSystem.Controllers
{
    ...
    public class HouseController : Controller
    {
        ...
        {
            if ((await houseService.HouseExists(id)) == false)
            {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            {
                logger.LogInformation("User with ID {0} attempted to edit other agents' house", User.Id());
                return RedirectToPage("/Account/AccessDenied", new { area = "Identity" });
            }

            var house = await houseService.HouseDetailsById(id);
            var category = await houseService.GetHouseCategoryId(id);
        ...
        public async Task<IActionResult> Edit(HouseModel model)
        {
            ...
            if ((await houseService.HouseExists(model.Id)) == false)
            {
